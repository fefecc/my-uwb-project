...
#define UWB_PHY_RX_SLOT_TIMEOUT_US 2500U /* 2.5ms, 给后半段 RX 槽更多余量 */
#define UWB_PHY_TX_DELAYED_MIN_US  500U  /* 延时发送最小提前量 */
#define UWB_PHY_HW_ERROR_THRESHOLD 5U    /* 连续硬件错误上限 */

/* ---- 多槽接收 / Anchor 延迟回复参数 ---- */
#define DISC_SLOT_WIDTH_US         2500U /* 每槽 2.5ms */
#define DISC_RX_SLOT_COUNT         4U    /* RX 槽数量 */
#define DISC_FIRST_SLOT_TIMEOUT_US 4500U /* 第一槽 4.5ms (GUARD + TX 上电时间) */
